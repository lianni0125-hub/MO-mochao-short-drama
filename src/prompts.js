...
采用真正的小程序风，情绪逻辑高于现实与生理常识，核心是亲密关系中的极端施害、身体毁损、囚禁与控制、公开羞辱、亲密背叛、猎奇噱头、狗血误会、恋爱脑纠缠、超常承伤与一轮比一轮离谱的升级。若与普通强烈或异常强烈档中的“现实利益动机、不得无动机发疯”等要求冲突，以本模式为准；人物可因偏执、占有欲、误会、对白月光的偏爱或扭曲感情实施远超现实收益的伤害。${stage==="outline"?"05必须把这些设计成明确发生的事件、可见伤害、关系选择与下一轮钩子，不能只把普通冲突换成狠话；受害者遭受不可原谅的伤害后仍可因爱、执念或误会继续纠缠，严重伤势也可在后续迅速恢复并继续行动，不必补写治疗过程或现实医学解释。":"严格执行05已经确定的小程序风事件，不得主动合理化、降级、改成普通争吵或用现实医学常识阻止下一轮剧情；只要05没有明确规定长期残疾、永久失去能力或持续昏迷，伤势默认可快速恢复，不要求解释。"}
小程序风只放宽现实尺度、生理恢复和人物情感理性，不放宽姓名、身份、首登场集、人物知情、金手指持有者、秘密揭露顺序、道具归属、必须发生链条与集尾钩子的连续性。当前情绪强度只决定对白、羞辱、压迫与反扑的表达密度：选择“强烈”也不得削弱05既定的离谱事件，选择“异常强烈”也不得越过05新增重大伤害。`:"";
