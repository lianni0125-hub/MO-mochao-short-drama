...
每集返回episode_no、title、dramatic_design、summary、hook、purpose、start_state、end_state、rhythm、emotion、card_relation。
...
每集只返回episode_no、title、summary、hook、purpose、start_state、end_state、required_plot、must_reveal、must_not_reveal、rhythm、emotion、card_relation。
...
【叙事人称｜全局最高优先级】
${narrativePersonRule}
从第一段到最后一段保持同一人称。此规则高于模板文风、样例、扩写要求和定向修订要求；任何材料若暗示另一种人称，只学习其剧情信息，不得跟随其人称。
