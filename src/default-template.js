export const DEFAULT_TEMPLATE = {
  ...
  scriptFormat:{
    ...
    rules:[
      ...
      "禁止使用瞳孔骤缩、眼睛一亮、眼中闪过、眼神一沉、嘴角上扬、眉头一皱、倒吸凉气等套路化微反应；禁用指节发白、青筋暴起、指甲掐进掌心、掌心渗出血丝等套路化AI身体细节；握紧拳头属于可拍动作，可在确有剧情作用时使用",
      "正文不使用任何圆括号或小括号；V.O./OS 直接写在角色名后；方括号只保留极少量必要蒙太奇提示",
      "开头立即承接上集悬念或进入当前危机，不回顾前情；结尾在危险、发现或强反应出现后立即停止，不做总结",
      "先生成2000–3000字、采用05所选叙事人称的小说中间稿，再转换为1500–2000字剧本；最终剧本为1–9个正式场次"
    ],
